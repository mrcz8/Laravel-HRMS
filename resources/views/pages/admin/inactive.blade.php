        ...
        <table class="table" id="agenttable" style="width: 100%;">
            ...
            @foreach($inactive as $agent)
                <tr  id="table">
                    ...
                    @if($agent->status==1) 
                    <td><a type="button" style="background:none;border:none; color:#faad26;text-decoration: none;"><b>Active  </b></a> ( {{$agent->status_info}} )</td>
                    @else
                    <td><a type="button" style="background:none;border:none; color:red;text-decoration: none;"><b>Inactive  </b></a> ( {{$agent->status_info}} )</td>
                    @endif 
